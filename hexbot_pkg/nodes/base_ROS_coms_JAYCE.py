...
class SimpleParticleFilter(object):  # classes make things better, promise
    ...
    def __init__(self):
        ...
        self.pub = rospy.Publisher('chatter_count', String, queue_size=10)
...
#########################################################
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            # wait until next time this code should run (according to
            # rospy.Rate above)
            r.sleep()
...
def locations():
    ...
    x = 6
    # x distance of the foot from the theta servo
    z = -3
    # z distance of the foot from the theta servo
    SL = 4
    # Side length of the body
    xp = math.sin(math.radians(60)) * SL
    # x offset for diagonal sides
    yp = math.cos(math.radians(60)) * SL
    # y offset for diagonal sides
    # y path for the foot to follow for walk
